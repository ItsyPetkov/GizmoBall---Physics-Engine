 ...
 */public final class Circle implements Serializable {
  ...
  private final physics.Vect centerPoint;
   ...
   */
  public Circle(physics.Vect center, double r) {
    if ((r < 0) || (center == null)) {
  ...
  public Circle(Point2D center, double r) {
    this(new physics.Vect(center), r);
  }
  ...
  public boolean equals(physics.Circle c) {
    if (c == null) return false;
    return (radius == c.radius) && centerPoint.equals(c.centerPoint);
  }

  public boolean equals(Object o) {
    if (o instanceof physics.Circle)
      return equals((physics.Circle) o);
    else
      return false;
  }
