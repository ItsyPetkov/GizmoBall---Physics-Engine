...
public class IntervalList
   ...
   **/   
  public IntervalList(physics.IntervalList il) {
   ...
   * <code>il</code>.
   **/
  public void addIntervalList(physics.IntervalList il) {
   ...
   * <code>il</code>.
   **/
  public void removeIntervalList(physics.IntervalList il) {
    Iterator iter = il.intervals.iterator();
    while (iter.hasNext()) {
      Interval i = (Interval) iter.next();
  ...
  public boolean equals(Object o) {
    if (o instanceof physics.IntervalList) {
      physics.IntervalList il = (physics.IntervalList) o;
