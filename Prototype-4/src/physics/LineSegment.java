 ...
 **/public final class LineSegment implements Serializable {
  ...
  private final physics.Vect p1;
  private final physics.Vect p2;
   ...
   */
  public LineSegment(physics.Vect p1, physics.Vect p2) {
    if ((p1 == null) || (p2 == null)) {
  ...
  public LineSegment(Line2D l2d) {
    this(new physics.Vect(l2d.getP1()), new physics.Vect(l2d.getP2()));
  }
  ...
  public LineSegment(double x1, double y1, double x2, double y2) {
    this(new physics.Vect(x1, y1), new physics.Vect(x2, y2));
  }

  /**
   * @return the first point of <code>this</code> line segment.
   */
  public physics.Vect p1() {
    return p1;
  }
  ...
  public physics.Angle angle() {
    return new physics.Angle(p2.x() - p1.x(), p2.y() - p1.y());
  }
  ...
  public boolean equals(physics.LineSegment ls) {
    if (ls == null) return false;
    return (p1.equals(ls.p1) && p2.equals(ls.p2));
  }

  public boolean equals(Object o) {
    if (o instanceof physics.LineSegment)
      return equals((physics.LineSegment) o);
    else
      return false;
  }
