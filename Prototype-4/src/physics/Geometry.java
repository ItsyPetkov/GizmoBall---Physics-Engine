...
public class Geometry {
  ...
  private static physics.GeometryInterface geometry = new physics.GeometryImpl();
   ...
   **/
  public static void setGeometry(physics.GeometryInterface impl) {
    if (impl == null) { 
  ...
  public static void setTuningParameters(double maximumForesight,
					 ...
					 int numberOfSlices) {
    if (useDoughnut) {
      setGeometry(new physics.GeometryImpl(maximumForesight, numberOfSlices));
    } else {
      setGeometry(new physics.SimpleGeometry(maximumForesight, numberOfSlices));
    }
  }
  ...
  public static void setForesight(double maximumForesight) {
    if (maximumForesight <= 0.1) {
      setGeometry(new physics.SimpleGeometry(maximumForesight, 15));
    } else {
      setGeometry(new physics.GeometryImpl(maximumForesight, 15));
    }
  }
  ...
  public static class VectPair
    implements Serializable
  {
    public final physics.Vect v1;
    public final physics.Vect v2;

    /**
     * Creates a VectPair with <code>v1</code> and
     * <code>v2</code> as given
     **/
    public VectPair(physics.Vect v1, physics.Vect v2) {
      this.v1 = v1;
      this.v2 = v2;
    }
   ...
   * segment.
   *
   * @see #perpendicularPointWholeLine(physics.LineSegment, physics.Vect)
   **/
  static public physics.Vect perpendicularPoint(physics.LineSegment line,
                                                physics.Vect point) {
   ...
   *
   * @see #perpendicularPoint(physics.LineSegment, physics.Vect)
   **/
  public static physics.Vect perpendicularPointWholeLine(physics.LineSegment line,
                                                         physics.Vect point) {
   ...
   **/
  public static physics.Vect applyReflectionCoeff(physics.Vect incidentVect,
   ...
   **/
  public static double timeUntilWallCollision(physics.LineSegment line,
                                              physics.Circle ball,
   ...
   **/
  public static physics.Vect reflectWall(physics.LineSegment line,
                                         physics.Vect velocity,
   ...
   **/
   static public double distanceSquared(physics.Vect v1, physics.Vect v2) {
   ...
   * @see Double#POSITIVE_INFINITY
   **/
  static public double timeUntilCircleCollision(physics.Circle circle,
                                                physics.Circle ball,
                                                physics.Vect velocity) {
   ...
   **/
  public static physics.Vect reflectCircle(physics.Vect circle,
                                           physics.Vect ball,
                                           physics.Vect velocity,
                                           double reflectionCoeff) {
   ...
   * by <code>a</code>
   **/
  public static physics.Vect rotateAround(physics.Vect point, physics.Vect cor, physics.Angle a) {
   ...
   * by <code>a</code>
   **/
  public static physics.LineSegment rotateAround(physics.LineSegment line, physics.Vect cor, physics.Angle a) {
   ...
   * by <code>a</code>
   **/
  public static physics.Circle rotateAround(physics.Circle circle, physics.Vect cor, physics.Angle a) {
   ...
   * @see Double#POSITIVE_INFINITY
   **/
  public static DoublePair timeUntilCircleCollision(physics.Circle circle,
                                                    physics.Vect point,
                                                    physics.Vect velocity)
  {
   ...
   * @see <a href="#endpoint_effects">endpoint effects</a>
   **/
  public static double timeUntilRotatingWallCollision(physics.LineSegment line,
                                                      physics.Vect center,
   ...
   **/
  public static physics.Vect reflectRotatingWall(physics.LineSegment line,
                                                 physics.Vect center,
                                                 double angularVelocity,
                                                 physics.Circle ball,
                                                 physics.Vect velocity) {
  ...
  public static double timeUntilRotatingCircleCollision(physics.Circle circle,
                                                        physics.Vect center,
                                                        double angularVelocity,
                                                        physics.Circle ball,
                                                        physics.Vect velocity)
   ...
   * circle
   **/
  public static physics.Vect reflectRotatingCircle(physics.Circle circle,
                                                   physics.Vect center,
                                                   double angularVelocity,
                                                   physics.Circle ball,
                                                   physics.Vect velocity) {
   ...
   * @see Double#POSITIVE_INFINITY
   **/
  public static double timeUntilBallBallCollision(physics.Circle ball1,
                                                  physics.Vect vel1,
   ...
   **/
  public static VectPair reflectBalls(physics.Vect center1,
                                      double mass1,
